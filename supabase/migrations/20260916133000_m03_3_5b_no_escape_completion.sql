create table if not exists public.game_rounds (
  ...
  no_escape_scenario_id text null,
  no_escape_response_id text null,
  no_escape_defense_started_at timestamptz null,
  verdict text null,
...
alter table public.game_rounds
  ...
  add column if not exists no_escape_scenario_id text null,
  add column if not exists no_escape_response_id text null,
  add column if not exists no_escape_defense_started_at timestamptz null,
...
comment on column public.game_rounds.no_escape_scenario_id is
  'M03.3.5B canonical scenario id for persisted No Escape.';

comment on column public.game_rounds.no_escape_response_id is
  'M03.3.5B canonical forced response id for persisted No Escape.';

comment on column public.game_rounds.no_escape_defense_started_at is
  'M03.3.5B canonical timestamp for the shared 15-second No Escape defense.';
